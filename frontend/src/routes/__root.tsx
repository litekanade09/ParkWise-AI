...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ParkWise AI" },
      { property: "og:description", content: "Intelligent Parking Operations & Occupancy Monitoring Platform with real-time availability and smart booking." },
