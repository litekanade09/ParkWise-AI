...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SmartPark AI" },
      { property: "og:description", content: "AI-powered smart parking management with real-time availability and smart booking." },
